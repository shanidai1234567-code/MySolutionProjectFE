...
namespace Model
{
    public class Report : BaseEntity
    {
        ...
        public int  Help_Category { get => help_Category; set => help_Category = value; }
        public string Description { get => description; set => description = value; }
        public string Photo_Optinal { get => photo_optinal; set => photo_optinal = value; }
        public int City_Num { get => city_num; set => city_num = value; }

        public override string ToString()
        {
            return $"PasserBy_ID: {passerBy_ID}, Update_Time:{update_Time}, Location_X:{location_X}, Location_Y: {location_Y}" +
                $"Help_Category: {help_Category}, Description: {description}, Photo_Optinal: {photo_optinal}, City_Num: {city_num}.";
        }
    }
}
