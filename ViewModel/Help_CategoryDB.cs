...
namespace ViewModel
{
    public class Help_CategoryDB : BaseDB
    {
        public new Help_CategoryList SelectAll()
        {
            command.CommandText = $"SELECT * FROM Help_Category";
            Help_CategoryList pList = new Help_CategoryList(base.Select());
            return pList;
        }
        ...
        static private Help_CategoryList list = new Help_CategoryList();
